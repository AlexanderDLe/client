...
- With the new React App V2 release, I will now be using SASS on future projects! Within the documentation, the React team specified that SASS will now automatically be integrated.
